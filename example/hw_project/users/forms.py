...
class RegisterForm(UserCreationForm):
    ...
    password1 = CharField(max_length=16, min_length=3, required=True,widget=PasswordInput(attrs={'class': 'form-control'}))
    password2 = CharField(max_length=16, min_length=3, required=True,widget=PasswordInput(attrs={'class': 'form-control'}))
